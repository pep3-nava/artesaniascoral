const tipButtons = document.querySelectorAll('.tip-button, .tip-button_2 , .tip-button_3');


// Loop through all buttons (allows for multiple buttons on page)
tipButtons.forEach((button) => {
  let coin = button.querySelector('.coin , .coin_2 , .coin_3')

  // The larger the number, the slower the animation
  coin.maxMoveLoopCount = 30
